...
def switch_api_url(event):
    ...
    current_api_url = api_url_var.get()
    create_connection()
...
api_url_var.set(current_api_url)
api_url_menu = tk.OptionMenu(header_frame, api_url_var, *TRANSLATE_API_URLS, command=switch_api_url)
